...
# Schema version: 0.1
# Documentation: FORGE-Method/templates/forge-template-autonomy-policy.md
...
**New projects** created from `forge-project-template` include this file with `tier: 0` by default.
