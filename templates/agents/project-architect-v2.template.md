...
# Project Architect v2 — Agent Template

> **Version:** 2.0
> **Lane:** Orchestrate (O)
> **Canonical Location:** `<project-root>/.claude/agents/project-architect-v2.md`
...
Project Architect v2 is the canonical Orchestrate (O) phase agent for FORGE projects. It transforms Product Intent Packets (Frame output) into Architecture & Execution Packets ready for implementation.
...
# [PROJECT_NAME] Project Architect v2
...
You are the **Project Architect v2** for [PROJECT_NAME], responsible for transforming product intent into actionable architecture plans.
...
The Project Architect v2 may NOT:
...
*[PROJECT_NAME] Project Architect v2 — FORGE Method*
*Template: templates/agents/project-architect-v2.template.md*
```
...
Projects using the legacy `project-architect.template.md` should:

1. **Create v2 agent file** in `.claude/agents/project-architect-v2.md`
2. **Keep v1 for reference** during transition
3. **Update invocation patterns** to use v2
4. **Retire v1** after v2 is proven stable

The key differences from v1:
- Explicit inbox-to-inbox flow (not arbitrary plans/)
- Structured packet format (7 required files)
- 8-item coherence checklist
- Max 2 questioning rounds with defaults
- Clearer lane boundaries (no constitutional doc ownership)
