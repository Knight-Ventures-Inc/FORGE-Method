...
The full agent instruction specification is maintained in:

```
forge-genesis-vault/03_agent_instructions/product-strategist/
├── agent-spec.md           ← Complete specification
├── questioning-patterns.md ← Reusable question templates
├── domain-extensions.md    ← Domain-specific artifacts
├── coherence-checklist.md  ← Stop condition checklist
└── examples/               ← Sample Product Intent Packets
```
