...
*Note: In Knight Ventures projects, the Human Lead is typically Leo. The role is intentionally abstracted so FORGE can transfer to any team.*
...
FORGE is stewarded by **Knight Ventures, Inc.** The methodology evolves through community contribution, but coherence is preserved through a governed review process.
