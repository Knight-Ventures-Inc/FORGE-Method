...
The **FORGE Genesis Vault** (`forge-genesis-vault/`) contains the spawn system for bootstrapping FORGE agents:

- **Spawn specifications** for CP (Jordan) and other agents
- **Project Genesis** files for new project creation
- **Constitutional document templates**
- **Prompt templates** and task brief formats

Genesis Vault is the seed that creates the seed — it bootstraps the agents that bootstrap your projects.
...
FORGE is maintained by Knight Ventures, Inc. with community input.
...
The FORGE Method is proprietary methodology of Knight Ventures, Inc.
